...
public class WeloveHeader extends LinearLayout implements IHeaderView {
    ...
    public WeloveHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeloveHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
